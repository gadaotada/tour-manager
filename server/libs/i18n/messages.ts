...
const serverOwnMessages = {
    en: {
        ...
        "errors.users.selfDelete": "You cannot delete your own user.",
        "errors.users.selfDisable": "You cannot disable your own user.",
        "errors.users.selfPermissionUpdate": "You cannot update your own permissions.",
    ...
    bg: {
        ...
        "errors.users.selfDelete": "Не можете да изтриете собствения си потребител.",
        "errors.users.selfDisable": "Не можете да деактивирате собствения си потребител.",
        "errors.users.selfPermissionUpdate": "Не можете да променяте собствените си права.",
